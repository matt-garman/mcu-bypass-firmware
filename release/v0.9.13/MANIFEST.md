...
Full detail: [DESIGN_DOCUMENTATION.adoc](https://github.com/matt-garman/mcu-bypass-firmware/blob/v0.9.13/DESIGN_DOCUMENTATION.adoc#pic10f320-architecture).
...
- **Source commit:** `c8bd78278276c6b7d8e24e369f82e4641e61c1ca`
...
- **Final resource evidence:** `evidence/resource-tables.log` (SHA-256 `9c90a98a392d76c261caf7c9b2198aa666d2f9972727d1ec2c3e1b9f7138f961`)
- **Evidence index:** `evidence/INDEX` (SHA-256 `93584744961c8e43b9bc5bf7a8f0dccad590f7f787f6e27032e73c677c447589`), 36 retained files by role and terminal record
- **Built:** 2026-09-06T19:50:50Z by `matt` on `Linux 6.12.33-production+truenas x86_64`
...
| attiny202_cd4053_simple | SOAK PASS: 3600000 ms (1.00 h) simulated. resets=0 liveness_fails=0 checks=60 witness_checks=3840 in 44.1s wall. |
| attiny202_cd4053_with_mute | SOAK PASS: 3600000 ms (1.00 h) simulated. resets=0 liveness_fails=0 checks=60 witness_checks=3840 in 42.0s wall. |
| attiny202_tq2_l2_5v_relay | SOAK PASS: 3600000 ms (1.00 h) simulated. resets=0 liveness_fails=0 checks=60 witness_checks=3840 in 43.4s wall. |
...
scripts/verify-release-images.sh release/v0.9.13 build_avr_classic build_avr_xt build_pic10f322 build_pic10f320 build_pic12f675
```
