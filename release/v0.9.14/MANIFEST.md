...
Full detail: [DESIGN_DOCUMENTATION.adoc](https://github.com/matt-garman/mcu-bypass-firmware/blob/v0.9.14/DESIGN_DOCUMENTATION.adoc#pic10f320-architecture).
...
- **Source commit:** `2dec51d72b24e7a0acca7ec4c49d864881b15f16`
- **Soak duration per combination:** 86400000 ms
- **Soak combinations:** 18
- **PIC12F675 qualified matrix:** `evidence/pic12f675-qualified-matrix.json` (SHA-256 `71385110b75f4b966e69f45037ccb38987a22ff061389ed4dbff9f0291fa9a1b`)
- **Final resource evidence:** `evidence/resource-tables.log` (SHA-256 `a536abc2c44e3da128187bec01c370963b75755989325298606ca1e544acc1d3`)
- **Evidence index:** `evidence/INDEX` (SHA-256 `228827930c2b109c24e10abe70a0c927b81f6ae465d7eb72ece34fee39753c72`), 36 retained files by role and terminal record
- **Soak input key:** `SOAK_KEY` (SHA-256 `16af68a5e40cc15c77cd3a75f563513569c123613ac8222a7204639f6c8903f4`), 18 combinations over 28 driver sources and 6 harnesses
- **Soak provenance:** run for this release
- **Built:** 2026-09-12T02:14:35Z by `matt` on `Linux 6.12.33-production+truenas x86_64`
...
| yasimavr (patched venv: version sdist patchset) | 0.1.6 3742dae364a8d65ff7d4180d00b40c0901656dafcea6e53e94db1127b7ec6285 6c4c034ea39ef1d26e429b751a803c224b18547ff72d4ca45523c3d1c0132923 5490fddd0fe29e70a87b00206342578ad0bc48a72bb7682ea1dfbe1797f482d7 |
...
| attiny202_cd4053_simple | SOAK PASS: 86400000 ms (24.00 h) simulated. resets=0 liveness_fails=0 checks=1440 witness_checks=92160 in 1038.3s wall. |
| attiny202_cd4053_with_mute | SOAK PASS: 86400000 ms (24.00 h) simulated. resets=0 liveness_fails=0 checks=1440 witness_checks=92160 in 1027.9s wall. |
| attiny202_tq2_l2_5v_relay | SOAK PASS: 86400000 ms (24.00 h) simulated. resets=0 liveness_fails=0 checks=1440 witness_checks=92160 in 999.3s wall. |
...
scripts/verify-release-images.sh release/v0.9.14 build_avr_classic build_avr_xt build_pic10f322 build_pic10f320 build_pic12f675
```
