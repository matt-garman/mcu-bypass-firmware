...
Full detail: [DESIGN_DOCUMENTATION.adoc](https://github.com/matt-garman/mcu-bypass-firmware/blob/v0.9.15/DESIGN_DOCUMENTATION.adoc#pic10f320-architecture).
...
- **Source commit:** `7369a2e3fddd29614c174c390bbb5060c214514d`
...
- **Final resource evidence:** `evidence/resource-tables.log` (SHA-256 `3a09cda948ffcf73cf1c3b8540b1b6217e4f6b885095510ede7fe347c832f70d`)
- **Evidence index:** `evidence/INDEX` (SHA-256 `e8196ea8ad5b0076d7cd49d932bf15764d494e6d5f1dfdbe5b4d62a9d70746c6`), 36 retained files by role and terminal record
- **Soak input key:** `SOAK_KEY` (SHA-256 `79a1c977c8f2896c2707d12033c37f9512903a399a451d71706fda0f05dc183e`), 18 combinations over 28 driver sources and 6 harnesses
- **Soak provenance:** the recorded soak of these exact inputs, run at commit `6bf958ce7389`
- **Built:** 2026-09-14T00:54:19Z by `matt` on `Linux 6.12.33-production+truenas x86_64`
...
| yasimavr (patched venv: version sdist patchset) | 0.1.6 3742dae364a8d65ff7d4180d00b40c0901656dafcea6e53e94db1127b7ec6285 d8233558e4c7b9353bc91035933e0a649f0d69a9f6e2a05ee3219de316d9cde7 |
...
| attiny202_cd4053_simple | SOAK PASS: 86400000 ms (24.00 h) simulated. resets=0 liveness_fails=0 checks=1440 witness_checks=92160 in 1061.8s wall. |
| attiny202_cd4053_with_mute | SOAK PASS: 86400000 ms (24.00 h) simulated. resets=0 liveness_fails=0 checks=1440 witness_checks=92160 in 1064.6s wall. |
| attiny202_tq2_l2_5v_relay | SOAK PASS: 86400000 ms (24.00 h) simulated. resets=0 liveness_fails=0 checks=1440 witness_checks=92160 in 1050.8s wall. |
...
scripts/verify-release-images.sh release/v0.9.15 build_avr_classic build_avr_xt build_pic10f322 build_pic10f320 build_pic12f675
```
