...
Full detail: [docs/pic10f320_special_case.md](../../docs/pic10f320_special_case.md).
...
- **Source commit:** `d3ba04061830e43b5cf3574fd71746ca8cf10814`
- **Soak duration per combination:** 86400000 ms
- **Soak combinations:** 15
- **Built:** 2026-07-30T18:25:56Z by `matt` on `Linux 6.12.33-production+truenas x86_64`
...
| attiny202_cd4053 | SOAK PASS: 86400000 ms (24.00 h) simulated. resets=0 liveness_fails=0 checks=1440 witness_checks=86400 in 657.2s wall. |
| attiny202_mute | SOAK PASS: 86400000 ms (24.00 h) simulated. resets=0 liveness_fails=0 checks=1440 witness_checks=86400 in 659.1s wall. |
| attiny202_relay | SOAK PASS: 86400000 ms (24.00 h) simulated. resets=0 liveness_fails=0 checks=1440 witness_checks=86400 in 661.2s wall. |
...
scripts/verify-release-images.sh release/v0.9.6 build_avr_classic build_avr_xt build_pic build_pic10f320
```
