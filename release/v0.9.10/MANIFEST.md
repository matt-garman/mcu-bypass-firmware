...
Full detail: [docs/pic10f320_special_case.md](https://github.com/matt-garman/mcu-bypass-firmware/blob/v0.9.10/docs/pic10f320_special_case.md).
...
- **Source commit:** `2027d2d7cead9ac7059d37e7072261b4a938694b`
- **Soak duration per combination:** 3600000 ms
- **Soak combinations:** 18
- **PIC12F675 qualified matrix:** `evidence/pic12f675-qualified-matrix.json` (SHA-256 `e67a69252f36d4eefd4039c3f47de04756f9ab4b2b95f467239594ec33555e15`)
- **Final resource evidence:** `evidence/resource-tables.log` (SHA-256 `fb93e815c6833908085360a5e4c27ae699ab7efd4af771f007c0bb20a190327c`)
- **Built:** 2026-08-28T22:51:45Z by `matt` on `Linux 6.12.33-production+truenas x86_64`
...
| attiny202_cd4053_simple | SOAK PASS: 3600000 ms (1.00 h) simulated. resets=0 liveness_fails=0 checks=60 witness_checks=3840 in 45.1s wall. |
| attiny202_cd4053_with_mute | SOAK PASS: 3600000 ms (1.00 h) simulated. resets=0 liveness_fails=0 checks=60 witness_checks=3840 in 40.5s wall. |
| attiny202_tq2_l2_5v_relay | SOAK PASS: 3600000 ms (1.00 h) simulated. resets=0 liveness_fails=0 checks=60 witness_checks=3840 in 42.7s wall. |
...
scripts/verify-release-images.sh release/v0.9.10 build_avr_classic build_avr_xt build_pic10f322 build_pic10f320 build_pic12f675
```
