...
// The cd4053_with_mute and tq2_l2_5v_relay output drivers call __delay_ms() exactly once per
...
// variant's mute/coil pin pattern. cd4053_simple never calls __delay_ms.
