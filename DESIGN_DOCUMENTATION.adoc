...
=== CD4053 vs TMUX4053 Notes
    ...
    * MCU high -> Switch signal low, MCU low -> Switch signal high
...
| ATtiny13a | cd4053  | 612 bytes           | 60% of 1 KB
| ATtiny13a | relay   | 652 bytes           | 64% of 1 KB
| ATtiny13a | mute    | 660 bytes           | 65% of 1 KB
| ATtiny45  | cd4053  | 638 bytes           | 16% of 4 KB
| ATtiny45  | relay   | 678 bytes           | 17% of 4 KB
| ATtiny45  | mute    | 686 bytes           | 17% of 4 KB
| ATtiny85  | cd4053  | 638 bytes           | 8% of 8 KB
| ATtiny85  | relay   | 678 bytes           | 8% of 8 KB
| ATtiny85  | mute    | 686 bytes           | 8% of 8 KB
|===
...
8% of flash and approximately 7% of its 512 bytes of SRAM).
...
| cd4053  | 342 words | 66.8% | 34 bytes | 53.1%
| relay   | 367 words | 71.7% | 34 bytes | 53.1%
| mute    | 372 words | 72.7% | 34 bytes | 53.1%
|===
...
72.7% is the tightest fit in the whole matrix) yet still leaves comfortable
headroom against the 512-word limit, which `make pic` gates on every build.
